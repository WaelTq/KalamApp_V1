        ...
        <View style={styles.container}>
          ...
          <View style={styles.icon}>
            ...
            <View style={styles.button}>
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Info')} style={[styles.iconChat,{borderWidth: 2,
    borderBottomColor: '#1c4c96',borderColor:'#fff'}]}> 
                    <Feather name="info"  size={32} color="#1c4c96" />
                </TouchableOpacity>
                <TouchableOpacity onPress={() => this.props.navigation.navigate('UserJoin')} style={[styles.iconChat]}> 
            ...
            <View style={styles.infoMeet}>
                <Text style={{marginTop:'7%',marginBottom:'7%',fontSize:14,fontWeight:"800",fontFamily:'SemiBold'}}>Meeting Name goes here</Text>
                ...
                <TouchableOpacity style={{height:'20%',marginTop:20,flexDirection:'row',alignItems:"center",justifyContent:'flex-end',}}>
                <Text style={{marginRight:8,fontSize:14,fontFamily:'SemiBold'}}>Share Meeting</Text>
